<h2><a href="https://leetcode.com/problems/print-immutable-linked-list-in-reverse">Print Immutable Linked List in Reverse</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an immutable linked list, print out all values of each node in reverse with the help of the following&nbsp;interface:</p>
